    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('ngo_manager', 'NGO Manager'), ('volunteer', 'Volunteer'), ('public', 'Public')], default='public', max_length=20)),
                ('phone', models.CharField(blank=True, default='', max_length=15)),
                ...
                ('ngo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='members', to='core.ngo')),
            ],
            options={
                'verbose_name': 'user',
